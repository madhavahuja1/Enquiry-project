...
{
	$cname=$_POST['cname'];
$sql = " SELECT * FROM erashan WHERE CandidateName='$cname' && a4>=75 ";
...
<body>
   ...
   <a  href="./index.php" target="_madhav"> <button class="enquiry">Logut <i class="fa-solid fa-arrow-right"></i> </button>
	...
	<section>
		<h1>Welcome TO COUNSLOUR Panel</h1>
		<h1>Candidate Details</h1>
		<div>
    <form action="" method="POST">
        <input type="text" placeholder="Enter Eligible Student" name="cname">
		...
		<table>
			...
			<tr>
				...
				<td><?php echo $rows['FathersPhoneNumber'];?></td>
				<td><?php echo $rows['CandidatesPhoneNumber'];?></td>
